!function() {
  ...
  function n(t) {
    ...
    var e = r.host;
    r.pathname;
    return 'http:' === r.protocol && (e = e.replace(/:80$/, '')),
    'https:' === r.protocol && (e = e.replace(/:443$/, '')),
      {
        host: e,
  ...
  l.widgetId.get = function() {
    ...
    h.prototype._getScriptsInfo = function() {
      ...
      var h, l = (void 0 === (h = i) && (h = location.host),
    ...
    h.prototype._replaceScript = function(t) {
      ...
      var l, d = '32px', p = isNaN(this.settings.height) ? this.settings.height : this.settings.height + 'px',
      ...
      this.settings.utm_source = location.hostname,
        ...
        this.iframe = this._createIframe(f, g, n, r, o.id);
      var w = this.iframeContainer.querySelector('.tradingview-widget-container__widget');
      if (w ? (this.script.parentNode.replaceChild(this.iframe, w),
        this.script.parentNode.removeChild(this.script)) : u ? (this.iframeContainer.appendChild(this.iframe),
        ...
        function(t, e, i) {
          ...
          window.addEventListener('message', n, !1);
            ...
            t.width && (e.iframe.style.width = t.width + 'px',
              e.iframeContainer.style.width = t.width + 'px'),
              e.iframe.style.height = t.height + 'px',
              e.iframeContainer.style.height = t.height + (e.hasCopyright ? 32 : 0) + 'px';
          }
        )),
        m) {
        var y = document.createElement('div');
        y.style.height = d,
          y.style.lineHeight = d,
          y.style.width = g,
    ...
    return function(t, i) {
      ...
      i.prototype.filterRawSettings = function(e) {
        ...
        try {
          ...
          h.height = (r = e.displayMode,
            n = e.isTransparent,
            o = this.hasCopyright,
            a = i,
            c = r === d.Adaptive && a ? a <= g : r === d.Compact,
            s = c ? 72 : 44,
          n || (s += 2),
          o && (s += 32),
            s);
